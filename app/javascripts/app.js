...
function Registerfarmer() {
  ...
  var argoset = ArgoChain.deployed();
  
  var password 	= document.getElementById("password").value;
  var fid 		= document.getElementById("fid").value;
  var loc 		= document.getElementById("loc").value;
  var fname 	= document.getElementById("fmane").value;
  ...
  console.log(usertype);
    ...
    argoset.newUser( parseInt(address),password,fid,fname,loc,contact,usertype, {from: account,gas:1500000}).then(function(result) {
...
function setSupplier(){
  ...
  var checkDate = document.getElementById("check-in-date").value;
  console.log ("set supplier values \nfid : "+ lotn + "\ndate : "+checkDate);
  var metaset = StructStorage.at("0xE153CfF7199Fec03fF7B823Db1B774351458597F");
